...
export const withChildrenSpan: Story = {
  ...
  args: {
    value: 56,
    showAnimation: false,
    children: <span className="font-medium font-mono text-sm">56.3</span>,
  },
};
...
export const withChildrenAvatar: Story = {
  args: {
    value: 76,
    children: (
      <div className="rounded-full flex items-center justify-center h-12 w-12 bg-neutral-100">
        <span className="text-sm font-medium text-neutral-500">JD</span>
      </div>
    ),
  },
};
