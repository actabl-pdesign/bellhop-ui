...
function UncontrolledChildren({ ...args }) {
  ...
  return (
    <div className="space-y-4">
      <DateRangePicker {...args} onValueChange={(value) => setValue(value)}>
        <DateRangePickerItem key="one" value="one" from={new Date(2025, 0, 1)}>
          2025/1/1 - Today
        </DateRangePickerItem>
        <DateRangePickerItem
          key="two"
...
export const UncontrolledDefaultDateRange: Story = {
  ...UncontrolledTemplate,
  args: {
    defaultValue: { from: new Date(2024, 10, 1), to: new Date() },
  },
};
...
export const UncontrolledDisabledDates: Story = {
  ...UncontrolledTemplate,
  args: {
    defaultValue: { from: new Date(2025, 10, 25), to: new Date() },
...
export const ControlledDefaultDateRange: Story = {
  ...ControlledTemplate,
  args: {
    value: { from: new Date(2024, 10, 1), to: new Date() },
  },
};
...
export const ControlledDefaultValue: Story = {
  ...ControlledTemplate,
  args: {
    value: { from: new Date(2024, 10, 1), to: new Date(), selectValue: "t" },
  },
};
