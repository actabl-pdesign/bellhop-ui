...
import { BaseColors, colorPalette, getColorClassNames, themeColorRange, bellhopTwMerge } from "lib";
...
const AreaChart = React.forwardRef<HTMLDivElement, SparkAreaChartProps>((props, ref) => {
  ...
  return (
    <div ref={ref} className={bellhopTwMerge("w-28 h-12", className)} {...other}>
