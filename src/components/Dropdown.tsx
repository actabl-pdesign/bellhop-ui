...
>(({ className, children, ...props }, forwardedRef) => (
  <DropdownMenuPrimitives.SubTrigger
    ...
    className={cx(
      // base
      "relative flex cursor-default select-none items-center rounded py-1.5 pl-2 pr-1 text-sm outline-none transition-colors data-[state=checked]:font-semibold",
      // text color
      "text-gray-800",
      // disabled
...
>(({ className, shortcut, hint, children, ...props }, forwardedRef) => (
  <DropdownMenuPrimitives.Item
    ...
    className={cx(
      // base
      "group/DropdownMenuItem relative flex cursor-pointer select-none items-center rounded py-1.5 pl-2 pr-1 text-sm outline-none transition-colors data-[state=checked]:font-semibold",
      // text color
      "text-gray-800",
      // disabled
      "data-[disabled]:pointer-events-none data-[disabled]:text-gray-400 data-[disabled]:hover:bg-none",
...
>(
  (
    ...
    <DropdownMenuPrimitives.CheckboxItem
      ...
      className={cx(
        // base
        "relative flex cursor-pointer select-none items-center gap-x-2 rounded py-1.5 pl-8 pr-1 text-sm outline-none transition-colors data-[state=checked]:font-semibold",
        // text color
        "text-gray-800",
        // disabled
        "data-[disabled]:pointer-events-none data-[disabled]:text-gray-400 data-[disabled]:hover:bg-none",
...
>(
  (
    ...
    <DropdownMenuPrimitives.RadioItem
      ...
      className={cx(
        // base
        "group/DropdownMenuRadioItem relative flex cursor-pointer select-none items-center gap-x-2 rounded py-1.5 pl-8 pr-1 text-sm outline-none transition-colors data-[state=checked]:font-semibold",
        // text color
        "text-gray-800",
        // disabled
        "data-[disabled]:pointer-events-none data-[disabled]:text-gray-400 data-[disabled]:hover:bg-none",
    ...
    >
      {iconType === "radio" ? (
        <span className="absolute left-2 flex size-4 items-center justify-center">
          <RiRadioButtonFill
            aria-hidden="true"
            className="size-full shrink-0 text-indigo-700 group-data-[state=checked]/DropdownMenuRadioItem:flex group-data-[state=unchecked]/DropdownMenuRadioItem:hidden"
          />
          <RiCheckboxBlankCircleLine
            aria-hidden="true"
