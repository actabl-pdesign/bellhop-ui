...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cx(
        "relative flex items-center rounded-lg bg-gray-800 px-1 shadow-lg",
        className,
      )}
      {...props}
    />
...
const CommandBarCommand = React.forwardRef<HTMLButtonElement, CommandProps>(
  (
    ...
    return (
      <span
        className={cx(
          "flex items-center gap-x-2 rounded-lg bg-gray-800 p-1 text-base font-medium text-gray-50 outline-none transition focus:z-10 sm:text-sm",
