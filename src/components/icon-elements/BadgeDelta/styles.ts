...
export const colors: { [key: string]: ColorTypes } = {
  [DeltaTypes.Increase]: {
    ...
    textColor: getColorClassNames(BaseColors.Green, colorPalette.iconText).textColor,
    ringColor: getColorClassNames(BaseColors.Green, colorPalette.iconRing).ringColor,
  },
