...
const TimeSegment = ({ segment, state }: TimeSegmentProps) => {
  ...
  return (
    <div
      ...
      className={cx(
        // base
        "shadow-xs outline-hidden relative block w-full appearance-none rounded-md border px-2.5 py-1.5 text-left uppercase tabular-nums transition sm:text-sm",
        // border color
        "border-gray-300",
        // text color
        "text-gray-900",
...
const triggerStyles = tv({
  base: [
    // base
    "shadow-xs outline-hidden peer flex w-full cursor-pointer appearance-none items-center gap-x-2 truncate rounded-md border px-3 py-2 transition-all sm:text-sm",
    // background color
    "bg-white",
    // border color
    "border-gray-300",
        ...
        return (
          <li key={`preset-${preset.label}`} className="sm:w-full sm:py-px">
            <button
              ...
              className={cx(
                // base
                "shadow-xs outline-hidden relative w-full overflow-hidden text-ellipsis whitespace-nowrap rounded-sm border px-2.5 py-1.5 text-left text-base transition-all sm:border-none sm:py-2 sm:text-sm sm:shadow-none",
                // text color
                "text-gray-700",
                // border color
                "border-gray-200",
