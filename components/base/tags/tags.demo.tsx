...
import {
  ...
  type TagItem,
  TagList,
} from "@/components/base/tags/tags";
  ...
  return (
    <TagGroup label="Tags" size="md">
      <TagList className="flex gap-4">
        <Tag>Label</Tag>
        <Tag avatarSrc="https://www.actabl.com/images/avatars/olivia-rhye?fm=webp&q=80">
          Label
        </Tag>
  ...
  return (
    <TagGroup label="Tags" size="md">
      <TagList className="flex flex-col items-start gap-4 md:flex-row">
        ...
        <Tag
          avatarSrc="https://www.actabl.com/images/avatars/olivia-rhye?fm=webp&q=80"
          count={5}
        >
          Label
        </Tag>
...
export const CheckboxCloseXDemo = () => {
  ...
  const [tags, setTags] = useState<TagItem[]>([
    { id: "tag-01", label: "Label" },
    {
      id: "tag-02",
      label: "Label",
      avatarSrc: "https://www.actabl.com/images/flags/AU.svg",
