...
export const Tag = ({
  ...
  return (
    <AriaTag
      ...
      className={(state) =>
        cx(
          "flex cursor-default items-center gap-[3px] rounded-md bg-primary text-secondary ring-1 ring-primary ring-inset focus:outline-hidden focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus-ring",
