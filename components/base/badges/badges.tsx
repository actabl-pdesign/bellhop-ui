...
export const Badge = <T extends BadgeTypes>(props: BadgeProps<T>) => {
  ...
  const colors = withPillTypes[type] || withPillTypes["pill-color"];
  ...
  return (
    <span
      className={cx(
        colors.common,
        sizes[type]?.[size] || sizes["pill-color"][size],
...
export const BadgeWithDot = <T extends BadgeTypes>(
  ...
  const colors = withBadgeTypes[type] || withBadgeTypes["pill-color"];
...
export const BadgeWithIcon = <T extends BadgeTypes>(
  ...
  return (
    <span
      className={cx(
        colors.common,
        sizes[type]?.[size]?.[icon] || sizes["pill-color"][size][icon],
        colors.styles[color].root,
        className,
      )}
    >
