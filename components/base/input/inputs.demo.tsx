...
export const LeadingTextDemo = () => {
  return (
    ...
    >
      <InputBase placeholder="www.actabl.com" tooltip="This is a tooltip" />
    </InputGroup>
  );
};
    ...
    <InputGroup
      ...
      trailingAddon={
        <Button
          ...
          onClick={() => copy(value || "www.actabl.com")}
        >
          Copy
        </Button>
      }
        ...
        <InputGroup
          ...
          trailingAddon={
            <Button
              ...
              onClick={() =>
                copy(inputValue1 || "www.actabl.com", "input-1")
              }
            >
              Copy
            </Button>
        ...
        <InputGroup
          ...
          trailingAddon={
            <Button
              ...
              onClick={() =>
                copy(inputValue2 || "www.actabl.com", "input-2")
              }
            >
              Copy
            </Button>
        ...
        <InputGroup
          ...
          trailingAddon={
            <Button
              ...
              onClick={() =>
                copy(inputValue3 || "www.actabl.com", "input-3")
              }
            >
              Copy
            </Button>
        ...
        <InputGroup
          ...
          trailingAddon={
            <Button
              ...
              onClick={() =>
                copy(inputValue4 || "www.actabl.com", "input-4")
              }
            >
              Copy
            </Button>
        ...
        <InputGroup
          ...
          trailingAddon={
            <Button
              ...
              onClick={() =>
                copy(inputValue5 || "www.actabl.com", "input-5")
              }
            >
              Copy
            </Button>
        ...
        <InputGroup
          ...
          trailingAddon={
            <Button
              ...
              onClick={() =>
                copy(inputValue6 || "www.actabl.com", "input-6")
              }
            >
              Copy
            </Button>
