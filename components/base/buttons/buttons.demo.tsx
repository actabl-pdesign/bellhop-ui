...
import CheckOutlinedIcon from "@react-md/material-icons/CheckOutlinedIcon";
  ...
  return (
    <div>
      <div className="mb-4 flex gap-8">
        <Button iconLeading={CheckOutlinedIcon} size="sm">
          Button
        </Button>
        <Button iconLeading={CheckOutlinedIcon} size="md">
          Button
        </Button>
        <Button iconLeading={CheckOutlinedIcon} size="lg">
          Button
        </Button>
      </div>
      <div className="mb-4 flex gap-8">
        <Button isDisabled iconLeading={CheckOutlinedIcon} size="sm">
          Button
        </Button>
        <Button isDisabled iconLeading={CheckOutlinedIcon} size="md">
          Button
        </Button>
        <Button isDisabled iconLeading={CheckOutlinedIcon} size="lg">
          Button
        </Button>
      </div>
      ...
      <div className="mb-4 flex gap-8">
        <Button size="sm" iconLeading={AddIcon} />
        <Button size="md" iconLeading={AddIcon} />
        <Button size="lg" iconLeading={AddIcon} />
      </div>
      <div className="mb-4 flex gap-8">
        <Button isDisabled size="sm" iconLeading={AddIcon} />
        <Button isDisabled size="md" iconLeading={AddIcon} />
        <Button isDisabled size="lg" iconLeading={AddIcon} />
      </div>
...
export const Secondary = () => {
  return (
    <div>
      <div className="mb-4 flex gap-8">
        <Button iconLeading={Edit02} color="secondary" size="sm">
          Button
        </Button>
        <Button iconLeading={Edit02} color="secondary" size="md">
          Button
        </Button>
        <Button iconLeading={Edit02} color="secondary" size="lg">
          Button
        </Button>
      </div>
      <div className="mb-4 flex gap-8">
...
export const Tertiary = () => {
  return (
    <div>
      <div className="mb-4 flex gap-8">
        <Button iconLeading={Edit02} color="tertiary" size="sm">
          Button
        </Button>
        <Button iconLeading={Edit02} color="tertiary" size="md">
          Button
        </Button>
        <Button iconLeading={Edit02} color="tertiary" size="lg">
          Button
        </Button>
      </div>
      <div className="mb-4 flex gap-8">
...
export const LinkColor = () => {
  return (
    <div>
      ...
      <div className="mb-4 flex gap-8">
        <Button color="link-color" size="sm" iconLeading={DownloadCloud02}>
          Button
        </Button>
        <Button color="link-color" size="md" iconLeading={DownloadCloud02}>
          Button
        </Button>
        <Button color="link-color" size="lg" iconLeading={DownloadCloud02}>
          Button
        </Button>
      </div>
      <div className="mb-16 flex gap-8">
    ...
    <div>
      <div className="mb-4 flex gap-8">
        <Button
          ...
          iconLeading={DeleteOutlinedIcon}
          size="sm"
        >
          Button
        </Button>
...
export const SecondaryDestructive = () => {
  return (
    <div>
      <div className="mb-4 flex gap-8">
        <Button color="secondary-destructive" iconLeading={DeleteOutlinedIcon} size="sm">
          Button
        </Button>
        <Button color="secondary-destructive" iconLeading={DeleteOutlinedIcon} size="md">
          Button
        </Button>
        <Button color="secondary-destructive" iconLeading={DeleteOutlinedIcon} size="lg">
          Button
        </Button>
      </div>
      <div className="mb-4 flex gap-8">
        <Button color="secondary-destructive" iconLeading={DeleteOutlinedIcon} isDisabled size="sm">
          Button
        </Button>
        <Button color="secondary-destructive" iconLeading={DeleteOutlinedIcon} isDisabled size="md">
          Button
        </Button>
        <Button color="secondary-destructive" iconLeading={DeleteOutlinedIcon} isDisabled size="lg">
          Button
        </Button>
      </div>
      <div className="mb-16 flex gap-8">
      ...
      <div className="mb-4 flex gap-8">
        <Button color="secondary-destructive" size="sm" iconLeading={DeleteOutlinedIcon} />
        <Button color="secondary-destructive" size="md" iconLeading={DeleteOutlinedIcon} />
        <Button color="secondary-destructive" size="lg" iconLeading={DeleteOutlinedIcon} />
      </div>
      <div className="mb-4 flex gap-8">
        <Button color="secondary-destructive" isDisabled size="sm" iconLeading={DeleteOutlinedIcon}/>
        <Button color="secondary-destructive" isDisabled size="md" iconLeading={DeleteOutlinedIcon}/>
        <Button color="secondary-destructive" isDisabled size="lg" iconLeading={DeleteOutlinedIcon}/>
      </div>
      <div className="flex gap-8">
        <Button
          color="secondary-destructive"
...
export const TertiaryDestructive = () => {
  return (
    <div>
      <div className="mb-4 flex gap-8">
        <Button color="tertiary-destructive" iconLeading={DeleteOutlinedIcon} size="sm">
          Button
        </Button>
        <Button color="tertiary-destructive" iconLeading={DeleteOutlinedIcon} size="md">
          Button
        </Button>
        <Button color="tertiary-destructive" iconLeading={DeleteOutlinedIcon} size="lg">
          Button
        </Button>
      </div>
      <div className="mb-4 flex gap-8">
      ...
      <div className="mb-4 flex gap-8">
        <Button color="tertiary-destructive" size="sm" iconLeading={DeleteOutlinedIcon} />
        <Button color="tertiary-destructive" size="md" iconLeading={DeleteOutlinedIcon} />
        <Button color="tertiary-destructive" size="lg" iconLeading={DeleteOutlinedIcon} />
      </div>
      <div className="mb-4 flex gap-8">
        <Button
          color="tertiary-destructive"
