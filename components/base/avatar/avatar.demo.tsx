...
import {
  AvatarAddButton,
  AvatarCompanyIcon,
} from "@/components/base/avatar/base-components";
...
export const ProfilePhoto = () => (
  <div className="flex flex-col gap-16">
    ...
    <div className="flex gap-8">
      <AvatarProfilePhoto size="sm" placeholderIcon={User01} />
      <AvatarProfilePhoto size="md" placeholderIcon={User01} />
      <AvatarProfilePhoto size="lg" placeholderIcon={User01} />
    </div>
