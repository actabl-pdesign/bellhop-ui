...
const items = [
  ...
  },
  {
    ...
    avatarUrl:
      "https://www.actabl.com/images/avatars/olivia-rhye?fm=webp&q=80",
  },
  {
    label: "Lana Steiner",
    id: "@lana",
  ...
  },
  {
    ...
    avatarUrl:
      "https://www.actabl.com/images/avatars/abraham-baker?fm=webp&q=80",
  },
  {
    label: "Adem Lane",
    id: "@adem",
    supportingText: "@adem",
    avatarUrl:
      "https://www.actabl.com/images/avatars/adem-lane?fm=webp&q=80",
  },
  {
    label: "Jackson Reed",
    id: "@jackson",
    ...
    avatarUrl:
      "https://www.actabl.com/images/avatars/jackson-reed?fm=webp&q=80",
  },
  {
    label: "Jessie Meyton",
    id: "@jessie",
    ...
    avatarUrl:
      "https://www.actabl.com/images/avatars/jessie-meyton?fm=webp&q=80",
  },
];
  ...
  const items: SelectItemType[] = [
    {
      ...
      supportingText: "@phoenix",
      icon: (
        <Dot className="size-2.5 text-fg-success-secondary in-disabled:text-fg-disabled_subtle" />
      ),
    },
    {
      label: "Olivia Rhye",
