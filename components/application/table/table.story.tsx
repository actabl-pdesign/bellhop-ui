...
Table01DividerLine.storyName = "Table 01 divider line (Expanded density)";
...
Table01AlternatingFills.storyName =
  "Table 01 alternating fills (Default density)";
...
Table01DividerLineSm.storyName = "Table 01 divider line sm (Condensed density)";
...
export const TableStartByUploadingFile = () => (
  <Tables.TableStartByUploadingFile />
);
