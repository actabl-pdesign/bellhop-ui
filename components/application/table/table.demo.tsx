...
export const Table01DividerLine = () => {
  ...
  return (
    <TableCard.Root density="expanded">
      <TableCard.Header
        title="Team members"
        badge="100 users"
        contentTrailing={
...
export const Table01DividerLineSm = () => {
  ...
  return (
    <TableCard.Root size="sm" density="condensed">
      <TableCard.Header
        title="Team members"
        badge="100 users"
        contentTrailing={
          ...
          {(item) => (
            <Table.Row id={item.name}>
              ...
              <Table.Cell>
                <BadgeWithDot
                  size="sm"
                  color={item.status === "Customer" ? "success" : "gray"}
                >
                  {item.status}
                </BadgeWithDot>
              </Table.Cell>
      ...
      <div className="flex items-center justify-center overflow-hidden px-8 pt-10 pb-12">
        <EmptyState size="sm">
          <EmptyState.Header pattern="circle">
            <EmptyState.Illustration type="search-fail" />
          </EmptyState.Header>
