...
export const PaginationPageMinimalCenter = () => (
  <Demos.PaginationPageMinimalCenter />
);
...
export const PaginationCardMinimalRightAligned = () => (
  <Demos.PaginationCardMinimalRightAligned />
);
PaginationCardMinimalRightAligned.storyName =
  "Pagination card minimal right aligned";

export const PaginationCardMinimalCenterAligned = () => (
  <Demos.PaginationCardMinimalCenterAligned />
);
PaginationCardMinimalCenterAligned.storyName =
  "Pagination card minimal center aligned";

export const PaginationCardMinimalLeftAligned = () => (
  <Demos.PaginationCardMinimalLeftAligned />
);
