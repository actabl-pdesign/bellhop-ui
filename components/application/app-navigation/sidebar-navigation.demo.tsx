...
} from "@/components/application/app-navigation/base-components/featured-cards.demo";
import type {
  NavItemDividerType,
  NavItemType,
    ...
    items: [
      {
        ...
        icon: () => (
          <Avatar
            src="https://www.actabl.com/logos/images/Catalog.jpg"
      ...
      },
      {
        ...
        icon: () => (
          <Avatar
            src="https://www.actabl.com/logos/images/Warpspeed.jpg"
            className="mr-2 size-5"
          />
        ),
        badge: (
      ...
      },
      {
        ...
        icon: () => (
          <Avatar
            src="https://www.actabl.com/logos/images/Boltshift.jpg"
            className="mr-2 size-5"
          />
        ),
        badge: (
      ...
      },
      {
        ...
        icon: () => (
          <Avatar
            src="https://www.actabl.com/logos/images/Sisyphus.jpg"
            className="mr-2 size-5"
          />
        ),
        badge: (
