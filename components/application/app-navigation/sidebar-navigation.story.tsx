...
export default {
  ...
  decorators: [
    withOverlayAware((Story, context) => (
...
export const SidebarNavigationSimpleDemo = () => (
  <Demos.SidebarNavigationSimpleDemo />
);
...
export const SidebarNavigationDualTierDemo = () => (
  <Demos.SidebarNavigationDualTierDemo />
);
...
export const SidebarNavigationSlimDemo = () => (
  <Demos.SidebarNavigationSlimDemo />
);
...
export const SidebarSectionDividersDemo = () => (
  <Demos.SidebarSectionDividersDemo />
);
...
export const SidebarNavigationSectionsSubheadingsDemo = () => (
  <Demos.SidebarNavigationSectionsSubheadingsDemo />
);
SidebarNavigationSectionsSubheadingsDemo.storyName =
