import{j as e}from"./jsx-runtime-D_NlE7bE.js";import{B as i}from"./Badge-CGP1UeOY.js";import{C as R}from"./check-DzJ08lTv.js";import"./iframe-TczdQGhE.js";import"./index-qfXV6w7r.js";import"./utils-Cq7e7suc.js";import"./index-BEG6t_k7.js";import"./createLucideIcon-CLyNMukn.js";const Q={title:"ui/Badge",component:i,tags:["autodocs"],argTypes:{variant:{options:["solid","soft","outline"],control:{type:"radio"}},color:{options:["brand","indigo","gray","green","red","amber","amber","purple","violet","rose","blue"],control:{type:"select"}},size:{options:["small","medium"],control:{type:"radio"}}},args:{variant:"solid",color:"brand",size:"medium",children:"Badge"},parameters:{layout:"centered",docs:{description:{component:"Displays a badge or a component that looks like a badge."}}}},r={args:{variant:"solid",color:"brand",size:"medium"}},s={args:{variant:"soft",color:"purple"}},o={args:{variant:"outline",color:"orange"}},a={args:{variant:"solid",color:"error"}},t={render:_=>e.jsxs(i,{..._,children:[e.jsx(R,{size:16}),"Success"]}),args:{variant:"soft",color:"success",size:"small"}},n={render:()=>e.jsxs("div",{className:"flex flex-row items-center gap-2",children:[e.jsx(i,{size:"small",color:"rose",children:"Small"}),e.jsx(i,{size:"medium",color:"rose",children:"Medium"}),e.jsx(i,{size:"large",color:"rose",children:"Large"})]}),args:{variant:"soft"}};var c,d,l,m,p;r.parameters={...r.parameters,docs:{...(c=r.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
    variant: "solid",
    color: "brand",
    size: "medium"
...
}`,...(h=(u=s.parameters)==null?void 0:u.docs)==null?void 0:h.source},description:{story:"Use the `soft` badge to call for less urgent information, blending\ninto the interface while still signaling minor updates or statuses.",...(v=(f=s.parameters)==null?void 0:f.docs)==null?void 0:v.description}}};var b,z,y,S,x;o.parameters={...o.parameters,docs:{...(b=o.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    variant: "outline",
    color: "orange"
  }
}`,...(y=(z=o.parameters)==null?void 0:z.docs)==null?void 0:y.source},description:{story:"Use the `outline` badge for overlaying without obscuring interface details,\nemphasizing clarity and subtlety..",...(x=(S=o.parameters)==null?void 0:S.docs)==null?void 0:x.description}}};var B,j,w,k,I;a.parameters={...a.parameters,docs:{...(B=a.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    variant: "solid",
    color: "error"
  }
